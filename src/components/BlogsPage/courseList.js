...
const CoursesList = ({ initialCategory = 'all' }) => {
  ...
  const topicRoutes = {
    AWS: "/aws-course-in-pune",
    // Azure: "/azure-course-in-pune",
    DevOps: "/devops-course-in-pune",
    "AI/ML": "/ai-ml-course-in-pune",
    "IT Course": "/courses/it",
  };
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 gap-4">
            {topicsToShow.map((topic, index) => {
              ...
              const topicRoute = topicRoutes[topic.name];
              const cardContent = (
                <div
                  key={topic.name}
              ...
              if (isSap) {
                ...
                return (
                  <Link href={topicRoute} key={topic.name}>
                    {cardContent}
                  </Link>
                );
              } else {
