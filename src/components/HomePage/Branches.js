...
const BranchesComponent = () => {
  ...
  return (
    <div className="py-8 mb-8 px-4 md:px-6">
      <div className="max-w-7xl mx-auto">
        {/* Gradient Container matching Our Stats background */}
        <div 
          className="branchesDotsBackground rounded-2xl shadow-lg p-6 md:p-8"
        >
                ...
                <div className="p-4">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <a
                      ...
                      aria-label={`Get directions to our ${branches[selectedBranch].city} office`}
                      title={`Get directions to our ${branches[selectedBranch].city} office`}
                  ...
                  <div className="flex gap-1">
                    {branches.map((branch, index) => (
                      <button
                        ...
                        className="branchDotButton"
                        style={{
                          "--branch-dot-color":
                            selectedBranch === index ? branch.color : "#d1d5db",
                        }}
                        data-active={selectedBranch === index}
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label={`Get directions to our ${branch.city} office`}
                    title={`Get directions to our ${branch.city} office`}
      ...
      {/* Custom CSS for the title styling and dotted background */}
      <style jsx global>{`
        .branchesDotsBackground {
          position: relative;
          background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%);
          overflow: hidden;
        }

        .branchesDotsBackground::before {
          content: "";
          position: absolute;
          inset: 0;
        ...
        .branchDotButton::before {
          content: "";
          width: 8px;
          height: 8px;
          border-radius: 9999px;
          background-color: var(--branch-dot-color);
          transform: scale(1);
          transition: transform 0.3s ease;
        }

        .branchDotButton[data-active="true"]::before {
          transform: scale(1.5);
        }
