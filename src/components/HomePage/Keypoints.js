  ...
  const hexagonData = [
    {
      ...
      color: "#98D8EF",
      cover: "https://res.cloudinary.com/djdhtkjhn/image/upload/v1784203241/experiencelogo_ab68ko_ncswep.webp",
    ...
    },
    {
      ...
      color: "#98D8EF",
      cover: "https://res.cloudinary.com/djdhtkjhn/image/upload/v1784203027/corporate-alt_e63qn0_e2hu5n.webp",
    ...
    },
    {
      ...
      color: "#98D8EF",
      cover: "https://res.cloudinary.com/djdhtkjhn/image/upload/v1784203075/cptraining_achvyr_dkir8f.webp",
    ...
    },
    {
      ...
      color: "#98D8EF",
      cover: "https://res.cloudinary.com/djdhtkjhn/image/upload/v1784203130/exp_alt_rzabxk_leej5p.webp",
    ...
    },
    {
      ...
      color: "#98D8EF",
      cover: "https://res.cloudinary.com/djdhtkjhn/image/upload/v1784202973/clock_hjnaoj_vdopt9.webp",
    ...
    },
    {
      ...
      color: "#98D8EF",
      cover: "https://res.cloudinary.com/djdhtkjhn/image/upload/v1784203299/job_assistance_vrgdyn_ulsrbf.webp",
          ...
          <div className={`keyNotes ${isMobile ? 'grid grid-cols-2 gap-6' : 'lg:ml-8 flex flex-col justify-center mt-8 space-y-6'} w-full lg:w-auto px-2 lg:px-0`}>
            {hexagonData.map((feature, index) => (
              <div 
                className={`note ${
  isMobile 
    ? 'flex flex-col items-center px-2 py-3 rounded-xl backdrop-blur-sm bg-white/[0.02] border border-white/10' 
                ...
                {isMobile ? (
                  <>
                    ...
                    <div className="text-white w-full text-center">
                      <div className='text-sm font-semibold mb-1 flex flex-col items-center'>
  {feature.title}
  <span className="w-10 h-[1px] bg-white/30 mt-1 rounded-full"></span>
</div>
                      <div className='text-xs leading-relaxed text-left'>{feature.desc}</div>
                    </div>
                  </>
                ) : (
                  <>
                    ...
                    <div className="max-w-md pl-5 text-left text-white text-sm">
